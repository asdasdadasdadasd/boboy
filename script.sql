...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  PRIMARY KEY (`cart_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10000140 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `oitem` (
  ...
  KEY `usr_id` (`usr_id`)
) ENGINE=MyISAM AUTO_INCREMENT=50000083 DEFAULT CHARSET=latin1;

-- Dumping data for table db_sleepnotgo.oitem: 7 rows
/*!40000 ALTER TABLE `oitem` DISABLE KEYS */;
INSERT INTO `oitem` (`oi_id`, `order_id`, `item_id`, `oi_qty`, `oi_subtotal`, `usr_id`, `oi_status`) VALUES
	(50000082, 20000065, 18, 1, 55.00, 1, 0),
	(50000081, 20000064, 30, 1, 145.00, 1, 0),
	(50000080, 20000064, 18, 1, 55.00, 1, 1),
	(50000079, 20000064, 17, 1, 45.00, 1, 1);
...
) ENGINE=MyISAM AUTO_INCREMENT=20000061 DEFAULT CHARSET=latin1;

-- Dumping data for table db_sleepnotgo.orders: 4 rows
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`order_id`, `order_total`, `created_at`, `order_status`, `approved_by`, `usr_id`) VALUES
	(20000065, 55.00, '2017-12-20 19:25:47', 0, 0, 1),
	(20000064, 245.00, '2017-12-20 18:08:03', 0, 0, 1);
